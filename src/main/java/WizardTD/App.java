...
public class App extends PApplet {
    ...
    public void setup() {
        ...
        this.grass.setSprite(this.loadImage("src/main/resources/WizardTD/grass.png"));
        this.grass2.setSprite(this.loadImage("src/main/resources/WizardTD/grass.png"));
    }
